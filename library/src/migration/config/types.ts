...
export const DatabaseConfigSchema = v.object({
  ...
  connection: v.object({
    ...
    options: v.optional(v.object({
      ...
      /** Read preference */
      readPreference: v.optional(v.picklist(['primary', 'primaryPreferred', 'secondary', 'secondaryPreferred', 'nearest'])),
...
export const MigrationSystemConfigSchema = v.object({
  ...
  environments: v.optional(v.record(v.string(), v.object({
...
export type MigrationSystemConfig = v.InferInput<typeof MigrationSystemConfigSchema>;
