...
Deno.test("sanitizeDocument - remove behavior", () => {
    ...
    const result = sanitizeDocument(input, { undefinedBehavior: 'remove', deep: true });
...
Deno.test("sanitizeDocument - convert to null behavior", () => {
    ...
    const result = sanitizeDocument(input, { undefinedBehavior: 'convert-to-null', deep: true });
...
Deno.test("sanitizeDocument - shallow sanitization", () => {
    ...
    const result = sanitizeDocument(input, { undefinedBehavior: 'remove', deep: false });
