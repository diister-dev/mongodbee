...
Deno.test("Integration test - MongoDB queue system usage example", async () => {
    ...
    const mockCollection = {
        async createIndex(_keySpec: Record<string, number>, options?: Record<string, unknown>) {
        ...
        async createIndexes(specs: Array<{ key: Record<string, number>; [key: string]: unknown }>) {
