...
test("Journey: Complete application lifecycle with validation", async () => {
  ...
  // ========================================
  const migration3 = migrationDefinition(
    "2025_01_03_1000_USER_AGE",
    "add_user_age",
    {
      parent: migration2,
      schemas: {
  ...
  // ========================================
  const migration4 = migrationDefinition(
    "2025_01_04_1000_COMMENTS",
    "add_comments_system",
    {
      parent: migration3,
      schemas: {
  ...
  // ========================================
  const migration5 = migrationDefinition(
    "2025_01_05_1000_LIKES",
    "add_likes_feature",
    {
      parent: migration4,
      schemas: {
  ...
  // ========================================
  const result5WithReversibility = await validateMigrationWithSimulation(
    migration5,
    {},
  );
  assertEquals(
...
test("Journey: Rollback to different points", async () => {
  ...
  assertEquals(
    r2.success,
    true,
    "Migration 2 should succeed and be reversible",
  );
  ...
  assertEquals(
    r3.success,
    true,
    "Migration 3 should succeed and be reversible",
  );
});
...
test("Journey: State verification at each step", async () => {
  ...
  assertEquals(
    r2.success,
    true,
    "State after adding increment should be valid",
  );
